...
def Connectdb():
    ...
    submitbutton = Button(dbroot, text='Submit', font=('roman', 15, 'bold'), width=20, bg='#243665', bd=6,
...
colors = ['red', 'green', 'yellow', 'gold', 'pink', 'blue', 'red2']
...
DataEntryFrame = Frame(root, bg='#243665', relief=GROOVE, borderwidth=5)
DataEntryFrame.place(x=10, y=80, height=600, width=500)
frontlabel = Label(DataEntryFrame, text='------------Welcome-------------', width=25, font=('arial', 22, 'italic bold'),
                   bg='#243665')
frontlabel.pack(side=TOP, expand=True)
addbtn = Button(DataEntryFrame, text='1. Add Student', width=25, font=('chiller', 20, 'bold'), bd=6, bg='#c1c1c1',
                activebackground='white', activeforeground='black', command=addstudent)
addbtn.pack(side=TOP, expand=True)
searchbtn = Button(DataEntryFrame, text='2. Search Student', width=25, font=('chiller', 20, 'bold'), bd=6, bg='#c1c1c1',
                   activebackground='white', activeforeground='black', command=searchstudent)
searchbtn.pack(side=TOP, expand=True)
deletebtn = Button(DataEntryFrame, text='3. Delete Student', width=25, font=('chiller', 20, 'bold'), bd=6, bg='#c1c1c1',
                   activebackground='white', activeforeground='black', command=deletestudent)
deletebtn.pack(side=TOP, expand=True)
updatebtn = Button(DataEntryFrame, text='4. Update Student', width=25, font=('chiller', 20, 'bold'), bd=6, bg='#c1c1c1',
                   activebackground='white', activeforeground='black', command=updatestudent)
updatebtn.pack(side=TOP, expand=True)
showallbtn = Button(DataEntryFrame, text='5. Show All', width=25, font=('chiller', 20, 'bold'), bd=6, bg='#c1c1c1',
                    activebackground='white', activeforeground='black', command=showstudent)
showallbtn.pack(side=TOP, expand=True)
exportbtn = Button(DataEntryFrame, text='6. Export Data', width=25, font=('chiller', 20, 'bold'), bd=6, bg='#c1c1c1',
                   activebackground='white', activeforeground='black', command=exportstudent)
exportbtn.pack(side=TOP, expand=True)
exitbtn = Button(DataEntryFrame, text='7. Exit', width=25, font=('chiller', 20, 'bold'), bd=6, bg='#c1c1c1',
                 activebackground='white', activeforeground='black', command=exitstudent)
exitbtn.pack(side=TOP, expand=True)
##-----------------------------------------------------------ShowData frame Intro


ShowDataFrame = Frame(root, bg='#243665', relief=GROOVE, borderwidth=5)
ShowDataFrame.place(x=540, y=80, height=600, width=620)

# -------------------------------------Show Data Frame
style = ttk.Style()
style.configure('Treeview.Heading', font=('chiller', 20, 'bold'), foreground='blue')
style.configure('Treeview', font=('times', 15, 'bold'), background='#c1c1c1', foreground='black')
...
count = 0
text = ''
SliderLabel = Label(root, text=ss, relief=GROOVE, font=('chiller', 30, 'italic bold'), borderwidth=5, width=35,
                    bg='#243665')
...
# Time
#########################################################################################
clock = Label(root, font=('times', 14, 'bold'), relief=GROOVE, borderwidth=4, bg='#243665')
clock.place(x=10, y=0)
Tick()
#############################################################################################
# ConnectDatabase
##########################################################################################
connectbutton = Button(root, text='Connect To Database', width=15, font=('times', 15, 'bold'), relief=GROOVE,
                       borderwidth=4, bg='#243665', bd=6, activebackground='white', activeforeground='black',
                       command=Connectdb)
